...
USER = "godmodevegeta"
BIRTHDAY = date(2000, 2, 2)  # YYYY, MM, DD
JOINED_YEAR = 2015             # Year you created your GitHub account
W = 56                         # Column width for formatting

# ASCII Art (Replace with your own 25-30 line ASCII image/logo)
ART = r"""
%%%%%**%%%#********+:..................-@@@@....
%%%%#**%%%***********+-.................=@@:....
@%%%***********%#*******:.......:........#=.....
...
def info_lines(s):
    ...
    return [
        ...
        [],
        kv("Languages", "Python, Rust, Go, TypeScript"),
        kv("Hobbies", "Open Source, Gaming"),
        [],
        rule("Contact"),
        kv("Email", "your.email@example.com"),
        kv("LinkedIn", "in/your-profile"),
        [],
        rule("GitHub Stats"),
